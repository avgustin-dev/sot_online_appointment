    ...
    >
      ...
      {!compact && (
        <ul className="mt-2 list-disc space-y-0.5 pl-5 text-sm text-slate-700">
          ...
          <li>
            {isKy
              ? "Тема кабыл алуунун компетенциясында (сот өндүрүшүн уюштуруу, соттун иши, колдонуудагы мыйзамдарга өзгөртүү)."
              : "Тема относится к компетенции приёма (организация судопроизводства, деятельность суда, по вопросам внесения изменений в действующее законодательство КР)."}
          </li>
        </ul>
      )}
