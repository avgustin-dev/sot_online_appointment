    ...
    <div className="mx-auto max-w-3xl space-y-5 page-enter">
          ...
          <li>
            ...
            <span className="text-xs text-slate-500">
              {isKy
                ...
                : "Изучение материалов, краткое содержание, перевод в этап «Готово к приёму». Конкретные судебные дела не рассматриваются."}
            </span>
          </li>
          <li>
            <strong>
      ...
      >
        <ul className="list-disc space-y-2 pl-5 text-sm text-slate-700">
          <li>
            {isKy
              ? "Кызматкер: карточка же календарь — «Отменить запись», «Вернуть в регистрацию»; датаны өзгөртүү — блок «Дата, время и статусы»."
              : "Сотрудник: карточка обращения или календарь — «Отменить запись», «Вернуть в регистрацию»; изменение даты — блок «Дата, время и статусы»."}
          </li>
          <li>
            {isKy
